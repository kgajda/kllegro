...
public class HibernateConfigurationForTest {
    ...
    public PGPoolingDataSource pgPoolingDataSource() throws SQLException {
        ...
        pgPoolingDataSource.setUrl("jdbc:postgresql://localhost:5432/kllegro_test");
    ...
    public SessionFactory sessionFactory() throws IOException, SQLException {
        ...
        sessionFactory.setConfigLocation(applicationContext.getResource("classpath:hibernate/hibernate_test.cfg.xml"));
